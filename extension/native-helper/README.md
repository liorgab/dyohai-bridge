...
1. `chrome://extensions/`
2. מצא את הכרטיס "D.Yohai Bridge"
...
2. `chrome://extensions/` → רענן את D.Yohai Bridge (↻)
...
3. בדוק ב-Registry: `regedit → HKCU\Software\Google\Chrome\NativeMessagingHosts\com.dyohai.bridge`
   - הערך ברירת המחדל צריך להצביע על `%LOCALAPPDATA%\DYohaiBridge\com.dyohai.bridge.json`
