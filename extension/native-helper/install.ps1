# install.ps1 - D.Yohai Bridge Native Helper Installer
# =======================================================
...
#   chrome://extensions/ → find "D.Yohai Bridge" → copy the ID
...
Write-Host "`n=== D.Yohai Bridge Native Helper Installer ===" -ForegroundColor Cyan
...
$manifestSrc = Join-Path $helperDir 'com.dyohai.bridge.json'

# Native manifests go in AppData\Local (no admin required)
$manifestDir = "$env:LOCALAPPDATA\DYohaiBridge"
$manifestDst = Join-Path $manifestDir 'com.dyohai.bridge.json'
